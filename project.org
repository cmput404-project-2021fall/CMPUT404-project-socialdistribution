...
Front-end - Backend
  - [x] [x] As an author I want to make public posts.
  - [ ] [x] As an author I want to edit public posts.
  - [x] [x] As an author, posts I create can link to images. (via commonmark)
  ...
  - [x] [x] As an author, posts I make can be in simple plain text
  - [x] [x] As an author, posts I make can be in CommonMark
  - [x] [x] As an author, I want a consistent identity per server
  - [x] [x] As a server admin, I want to host multiple authors on my server
  ...
  - [x] [x] As an author, I want to post posts to my "stream"
  - [x] [x] As an author, I want to delete my own public posts.
  ...
  - [x] [x] As an author, I want to be able to use my web-browser to manage my profile
  - [x] [x] As an author, I want to be able to use my web-browser to manage/author my posts
  - [x] [x] As a server admin, I want to be able add, modify, and remove authors.
  - [x] [x] As a server admin, I want to OPTIONALLY be able to allow users to sign up but require my OK to finally be on my server
  - [ ] [ ] As a server admin, I don't want to do heavy setup to get the posts of my author's friends.
  - [x] [x] As a server admin, I want a restful interface for most operations
  - [x] [x] As an author, other authors cannot modify my public post
  - [x] [x] As an author, other authors cannot modify my shared to friends post.
  ...
  - [x] [x] As an author I should be able to browse the public posts of everyone
  - [x] [x] As a server admin, I want to be able to add nodes to share with
  - [x] [x] As a server admin, I want to be able to remove nodes and stop sharing with them.
  - [x] [x] As a server admin, I can limit nodes connecting to me via authentication.
  - [x] [x] As a server admin, node to node connections can be authenticated with HTTP Basic Auth
  - [x] [x] As a server admin, I can disable the node to node interfaces for connections that are not authenticated!
